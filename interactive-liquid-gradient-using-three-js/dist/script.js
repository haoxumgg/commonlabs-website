...
class App {
  constructor() {
    ...
    this.colorSchemes = {
      1: {
        // Custom Common Labs scheme
        // Hex Array: ["#362754", "#000000", "#BA27CE", "#0A0E27", "#BF30F3", "#0A0E27"]
        color1: new THREE.Vector3(0.212, 0.153, 0.329), // #362754
        color2: new THREE.Vector3(0.0, 0.0, 0.0), // #000000
        color3: new THREE.Vector3(0.729, 0.153, 0.808), // #BA27CE
        color4: new THREE.Vector3(0.039, 0.055, 0.153), // #0A0E27
        color5: new THREE.Vector3(0.749, 0.188, 0.953), // #BF30F3
        color6: new THREE.Vector3(0.039, 0.055, 0.153) // #0A0E27
      },
      2: {
  ...
  setColorScheme(scheme) {
    ...
    if (scheme === 1) {
      // Scheme 1: use full 6-color Common Labs palette
